"""Frozen core dataclasses: language, grounding, relations, observations,
...
class GroundedObject:
    """K_tau(x_tilde) = x: the canonical executable object — the CASES node."""
...
@dataclass(frozen=True, slots=True)
class Observation:
    """One revealed scalar empirical utility.  keeps a single scalar field."""

"""Core — Exploration Controller (acquistion-layer dial, proposal §17).
...
controller decides *where CASES proposes next* without touching the evidence
...
Paper-level boundary (v0.1 §"Paper-level claim boundary"): CASES does not claim
...
class ExplorationGear(str, Enum):
    ...
    the default, preserving the original behavior exactly.  Off does NOT

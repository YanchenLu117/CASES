"""this run-driver — copyable end-to-end execution (EXPERIMENT_PLAN §6, §9).
...
``cases.adapters.sciexplorer.arms``; an official-repo-aware runner selects among

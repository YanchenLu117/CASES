"""this shared scientific-campaign API (EXPERIMENT_BENCHMARKS_BASELINES_FINAL §4).

The versioned tool schema through which S2 (AI Scientist-v2), S3 (AI-Researcher),
A0/A1/A4 and CASES interact with GB1 and MADE (and, with an adapter, any
...
7. No baseline is forced to serialize an CASES state.
...
their planning loop with CASES/BO.  A ``toy_oracle`` is used for smoke; real

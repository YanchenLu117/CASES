"""CASES cross-line infrastructure hardening library.
...
``python -m cases.infra.<module>`` does not re-execute already-imported
submodules.
"""
...
_LAZY = {
    "Canary": ("cases.infra.canary", "Canary"),
    "Probe": ("cases.infra.canary", "Probe"),
    "probe_chat": ("cases.infra.canary", "probe_chat"),
    "probe_models": ("cases.infra.canary", "probe_models"),
    "SupervisionPolicy": ("cases.infra.supervisor", "SupervisionPolicy"),
    "run_under_supervisor": ("cases.infra.supervisor", "run_under_supervisor"),
    "touch_heartbeat": ("cases.infra.supervisor", "touch_heartbeat"),
    "Watchdog": ("cases.infra.watchdog", "Watchdog"),
    "Check": ("cases.infra.preflight", "Check"),
    "run_preflight_checks": ("cases.infra.preflight", "run_preflight_checks"),
    "SummaryTee": ("cases.infra.loghygiene", "SummaryTee"),
    "tee_process_output": ("cases.infra.loghygiene", "tee_process_output"),
    "rotate_by_size": ("cases.infra.loghygiene", "rotate_by_size"),
}

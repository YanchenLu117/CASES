"""Core — unified artifact pipeline (EXPERIMENT_PLAN §12.2).
...
for the plan's "official + CASES standardized outputs").  It consumes only the
public CASESModel surface; it never mutates the model.  The exploration gear is

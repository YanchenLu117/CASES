"""P0-c — frozen solution-field controller (Detail §3.4).
...
``CASES-State`` does NOT use this controller: the host policy receives only the
...
READOUT_ONLY_POLICY = "cases_state_uses_frozen_readout_schema_no_controller"
